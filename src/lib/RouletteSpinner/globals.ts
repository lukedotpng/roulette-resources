...
export const MISSION_TARGETS_LIST: MissionTargets = {
...
export const TARGET_BANNED_KILL_METHODS_LIST: TargetBannedKillMethods = {
    ...
    vanya_shah: ["consumed_poison", "impact_explosive", "drowning"],
    wazir_kale: ["fire", "drowning"],
    janus: ["falling_object", "fire"],
    nolan_cassidy: ["fire"],
    noel_crest: ["impact_explosive"],
    sinhi_akka: [],
...
export const MISSION_CONDITIONS_MAP: MissionSpinOptions = {
    paris: {
...
export const TARGET_UNIQUE_KILLS_LIST: TargetUniqueKills = {
    ...
    claus_strandberg: [],
    reza_zaydan: [],
    jordan_cross: ["smother_in_cake"],
    ken_morgan: [],
    sean_rose: ["explosive_watch_battery", "overpowered_nitro_charge"],
    ezra_berg: [],
    penelope_graves: [],
    maya_parvati: [],
    erich_soders: [
    ...
    sierra_knox: ["shoot_the_car", "poison_the_iv_drip"],
    robert_knox: [],
    ...
    carl_ingram: [],
    marcus_stuyvesant: [],
    alexa_carlisle: ["smother_in_pillow"],
    "ica_agent_#1": [],
    "ica_agent_#2": [],
    "ica_agent_#3": [],
    "ica_agent_#4": [],
...
export const CONDITION_ID_MAP: { [key: string]: string } = {
    "00": "pistol",
    pistol: "00",
    "01": "loud_pistol",
    loud_pistol: "01",
    ...
    b5: "smother_in_cake",
    smother_in_cake: "b5",
    b6: "poison_the_iv_drip",
    poison_the_iv_drip: "b6",
    b7: "overpressurize_the_steam_pool",
    overpressurize_the_steam_pool: "b7",
    b8: "hammer_&_sickle_sculpture",
    "hammer_&_sickle_sculpture": "b8",
    b9: "aztec_necklace",
    aztec_necklace: "b9",
    ba: "overpowered_nitro_charge",
    overpowered_nitro_charge: "ba",
    bb: "smother_in_pillow",
    smother_in_pillow: "bb",
} as const;

// DO NOT UPDATE
// ONLY FOR BACKWARDS COMPAT. ON OLD QUERY METHOD
