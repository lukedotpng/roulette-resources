import { ActionResponse, IsolationInsert } from "@/types";
import {
    Dialog,
    DialogPortal,
    DialogOverlay,
...
import { IsolationToMarkdown } from "@/utils/OldInfoToMarkdown";
                ...
                <DialogContent className="fixed top-1/2 left-1/2 w-[90%] max-w-[50rem] -translate-x-1/2 -translate-y-1/2 rounded-lg bg-white">
                    ...
                    <form
                        ...
                        action={async (formData: FormData) => {
                            ...
                            if (isNew) {
                                res = await CreateIsolationAction(formData);
                            } else {
                                res = await UpdateIsolationAction(formData);
                            }
                            if (!res.success) {
