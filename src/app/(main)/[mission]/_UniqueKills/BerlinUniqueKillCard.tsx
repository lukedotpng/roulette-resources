...
export default function BerlinUniqueKillCard({
    ...
    return (
        <div className="w-full min-w-full flex-1 text-zinc-900">
            <div className="flex flex-wrap justify-center gap-2">
                {uniqueKills.map((uniqueKillMethod, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className="relative flex w-full min-w-full flex-1 flex-col gap-2 rounded-xl border-4 border-zinc-500 bg-white p-3 text-zinc-900 md:max-w-[40rem] md:min-w-[25rem]"
                        >
